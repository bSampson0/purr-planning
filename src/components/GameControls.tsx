  ...
  const handleBootPlayer = async (playerId: string) => {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
      <div className="flex flex-wrap justify-between items-center gap-4">
        <div>
          <h3 className="text-lg font-semibold mb-1 text-red-800 dark:text-red-300">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            {gameState === 'voting'
              ? (isAdmin
                ...
                : 'Wait for the admin to reveal cards')
      ...
      {showPlayerList && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-20">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 max-w-md w-full">
            <h3 className="text-lg font-bold mb-4 text-red-800 dark:text-red-300">
              Players in Game
            </h3>
            <div className="max-h-80 overflow-y-auto">
              {players.map(player => (
                ...
                >
                  <div className="w-10 h-10 rounded-full flex items-center justify-center text-lg font-bold bg-red-200 dark:bg-red-800 text-red-800 dark:text-red-200">
